...
const get_cli_command_string_1 = __importDefault(require("./get-cli-command-string"));
...
const commandDispatcher = {
    dispatch: (commandInfo) => __awaiter(void 0, void 0, void 0, function* () {
        if (store_1.default.hasPackage() && store_1.default.shouldShowPkgNotice()) {
            console_print_1.default.notice(`Current reference package: ${store_1.default.getPackage()}`);
        ...
        switch (mainCommand) {
            ...
            case command_constants_1.CMD_PATH:
                ...
                break;
            default:
                const cliCommand = yield get_cli_command_string_1.default();
                if (cliCommand) {
                    if (cliCommand === 'shell') {
                        console_print_1.default.notice(`NOTICE: Run "adb shell" in your terminal`);
                        break;
                    }
