    ...
    run() {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (utils_1.no(deviceIp)) {
                console_print_1.default.error(error_constants_1.EMPTY_DEVICE_IP_ADDRESS);
                return;
            }
            try {
                const hostIp = yield ipManager.getHostIpInNetwork(deviceIp); // Todo - Get host ip in same network as device ip
                if (utils_1.no(hostIp)) {
                    console_print_1.default.error(error_constants_1.EMPTY_HOST_IP_ADDRESS);
                    return;
                }
            ...
            return new Promise((resolve, reject) => __awaiter(this, void 0, void 0, function* () {
                ...
                spawn_shell_cmd_1.default(adbTcpipCmd, {
                    ...
                    stdout: function (stream, tcpipOutput) {
                        return __awaiter(this, void 0, void 0, function* () {
                            output += tcpipOutput;
                            console_print_1.default.info(tcpipOutput);
                        });
                    },
                });
            }));
